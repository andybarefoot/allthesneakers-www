...
$spiderPagesUrls = array(
	"http://www.endclothing.com/department/sneakers?p=1",
	"http://www.endclothing.com/department/sneakers?p=2",
	"http://www.endclothing.com/department/sneakers?p=3",
	"http://www.endclothing.com/department/sneakers?p=4",
	"http://www.endclothing.com/department/sneakers?p=5",
	"http://www.endclothing.com/department/sneakers?p=6",
	"http://www.endclothing.com/department/sneakers?p=7",
	"http://www.endclothing.com/department/sneakers?p=8",
	"http://www.endclothing.com/department/sneakers?p=9",
	"http://www.endclothing.com/department/sneakers?p=10"
	);
...
function findProducts(){
	...
	if ($thisPageUrls->length > 0) {
		...
		for ($i = 0; $i < $thisPageUrls->length; $i++) {
			...
			if ((strpos($iUrl,'/department/sneakers/') !== false)||(strpos($iUrl,'/catalog/product/') !== false)){
